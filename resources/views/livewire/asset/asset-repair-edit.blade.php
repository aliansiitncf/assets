<div>
    ...
    <div class="card bg-base-100 shadow-xl p-6">
        <form wire:submit="update">
                    ...
                    <fieldset class="fieldset">
                        ...
                        <div class="mt-5">
                            ...
                            <div class="flex flex-wrap items-start gap-4">
                                ...
                                @if ($repairImage)
                                    {{-- Preview gambar baru yang baru saja dipilih --}}
                                    <div class="relative">
                                ...
                                @elseif ($existingImagePath)
                                    {{-- Gambar lama yang sudah tersimpan --}}
                                    <div class="relative">
                                        <img src="{{ Storage::url($existingImagePath) }}" alt="Foto saat ini"
                                            class="w-28 h-28 rounded-lg object-cover border">
                                        <span
                                            class="badge badge-neutral badge-sm absolute -bottom-2 left-1/2 -translate-x-1/2">
                                            Foto saat ini
                                        </span>
                                    </div>
                                @endif
                            ...
                            <label class="label">
                                <span class="label-text-alt">
                                    Format JPG, JPEG, PNG • Maksimal 2 MB. Kosongkan jika tidak ingin mengganti
                                    foto.
                                </span>
                            </label>
            ...
            <div class="mt-4 px-2 flex gap-2">
                ...
                <a href="{{ route('asset.repair') }}" wire:navigate class="btn btn-ghost">
                    Batal
                </a>
            </div>
        </form>
    ...
    <div class="modal modal-open">
        <div class="modal-box">
            <button type="button" wire:click="$set('isOpen', false)" class="btn btn-sm btn-circle absolute right-2 top-2">✕</button>
            ...
            <form wire:submit="save">
                <div class="form-control mb-4">
                    ...
                    <input type="text" wire:model="name_component" class="input input-bordered w-full" autofocus />
